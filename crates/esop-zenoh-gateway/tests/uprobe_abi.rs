...
unsafe extern "C" {
    ...
    fn esop_zenoh_gateway_callback_begin_v1(request_id: u64, route_kind: u32);
    fn esop_zenoh_gateway_callback_end_v1(request_id: u64, route_kind: u32, outcome: u32);
}

#[test]
fn versioned_gateway_markers_keep_their_exact_c_abi_symbols() {
    ...
    unsafe {
        ...
        esop_zenoh_gateway_callback_begin_v1(8, RouteKind::Command as u32);
        esop_zenoh_gateway_callback_end_v1(8, RouteKind::Command as u32, 0);
    }
}
