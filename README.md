...
`crates/esop-profile-cia402/` 现已增加 CSP/CSV/CST 模式切换监督、实际模式确认、Operation Enabled 门槛和周期设定值首目标/限幅守卫；完整 PDO 对象绑定、厂商 quirk 和真实驱动互操作仍需 HIL 验证。
