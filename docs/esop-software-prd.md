...
超时故障和显式重启。完整 AL 激活编排、真实响应来源、物理从站互操作和 HIL
仍未完成，因此 FR-004 的完整产品验收仍保持开放。
